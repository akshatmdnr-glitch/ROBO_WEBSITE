...
export default function Footer() {
  return (
    <footer className="bg-[#0B1120] border-t border-[#1E293B] relative z-10 pt-16 pb-12 overflow-hidden">
      {/* Glow highlight */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-[1px] bg-gradient-to-r from-transparent via-[#06B6D4] to-transparent opacity-50" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-[#1E293B]">
          ...
          <div className="md:col-span-1 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-[#111827] border border-[#1E293B] flex items-center justify-center">
                <Cpu className="w-5 h-5 text-[#00E5FF]" />
              </div>
              <div>
                <h3 className="font-heading font-bold text-white text-base">AKSHAT MISHRA</h3>
                <p className="text-[10px] font-mono text-[#06B6D4]">ROBOTICS RESEARCH LAB</p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-3">
            <h4 className="text-xs font-mono font-semibold text-white uppercase tracking-wider text-[#06B6D4]">
              Navigation
            </h4>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-1.5">
              {['ROS2 Humble', 'C++20', 'CUDA', 'Nav2', 'Cartographer', 'STM32 micro-ROS', 'Isaac Sim', 'Python', 'OpenCV'].map((tech) => (
                <span
                  key={tech}
                  className="px-2 py-1 rounded bg-[#111827] border border-[#1E293B] text-[11px] font-mono text-[#94A3B8]"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              href="/resume"
              className="inline-flex items-center gap-1 text-xs text-[#00E5FF] hover:underline font-medium pt-1"
            >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#94A3B8]">
          ...
          <div className="flex items-center gap-4 text-[11px] font-mono">
            ...
            <span className="text-[#06B6D4]">Vercel Ready</span>
          </div>
        </div>
      </div>
    </footer>
